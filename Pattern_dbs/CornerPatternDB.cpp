...
CornerPatternDB::CornerPatternDB() : PatternDB(100179840) {}

CornerPatternDB::CornerPatternDB(uint8_t init_val) : PatternDB(100179840, init_val) {}

uint32_t CornerPatternDB::getDatabaseIndex(const RubikCube &cube) const {
